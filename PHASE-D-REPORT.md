...
(runtime-versioned spellings scoped to the composing object) and `30811371458`
(waiver inheritance gated on literal evidence, i.e. what is in the tree). Each was a
...
10. ~~**The rewritten D3 guard has not itself run in CI yet.**~~ **Closed** by
    run `30811371458`: the version now in the tree ran on a real bump on a
