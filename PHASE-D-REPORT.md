...
references too) and `30813012511` (waiver classification per object, i.e. what
is in the tree). Each was a
...
10. ~~**The rewritten D3 guard has not itself run in CI yet.**~~ **Closed** by
    run `30813012511`: the version now in the tree ran on a real bump on a
