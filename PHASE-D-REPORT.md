...
expansion) and `30807553403` (mapped-soname resolution and the symlink-aware
bundled inventory, i.e. what is in the tree). Each was a
...
10. ~~**The rewritten D3 guard has not itself run in CI yet.**~~ **Closed** by
    run `30807553403`: the version now in the tree ran on a real bump on a
